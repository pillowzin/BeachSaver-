...
class Player:
    def __init__(self, x, y):
        ...
        self.spritesheet = pygame.image.load("assets/sprites/player.png").convert_alpha()
    ...
    def draw(self, surface):
        # prancha
        board = pygame.image.load("assets/sprites/board.png").convert_alpha()
...
class Obstacle:
    ...
    def __init__(self, x=None):
        ...
        path = os.path.join("assets/sprites", sprite_file)
...
class ScoreText:
    ...
    def draw(self, surface):
        img = self.font.render(self.text, True, (255,255,0))
